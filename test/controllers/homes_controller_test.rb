...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { content: @home.content, nickname: @home.nickname, title: @home.title, user_id: @home.user_id } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { content: @home.content, nickname: @home.nickname, title: @home.title, user_id: @home.user_id } }
