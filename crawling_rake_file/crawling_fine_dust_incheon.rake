## rake "crawling_fine_dust_incheon:crawling_fine_dust_incheon"

namespace :crawling_fine_dust_incheon do
  require 'rubygems'
  require 'rest_client'
  require 'cgi'
  
  task crawling_fine_dust_incheon: :environment do
    ...
    headers = { :params => { CGI::escape('numOfRows') => '15',CGI::escape('pageNo') => '1', CGI::escape('sidoName') => "인천", CGI::escape('ver') => "1.3" } }
    ...
    for num in 0..@finedust_to_hash.length-1
      ...
      @finedust_result.province = "인천광역시"
