## rake "crawling_fine_dust_gwangju:crawling_fine_dust_gwangju"

namespace :crawling_fine_dust_gwangju do
  require 'rubygems'
  require 'rest_client'
  require 'cgi'
  
  task crawling_fine_dust_gwangju: :environment do
    ...
    headers = { :params => { CGI::escape('numOfRows') => '15',CGI::escape('pageNo') => '1', CGI::escape('sidoName') => "광주", CGI::escape('ver') => "1.3" } }
    ...
    for num in 0..@finedust_to_hash.length-1
      ...
      @finedust_result.province = "광주광역시"
