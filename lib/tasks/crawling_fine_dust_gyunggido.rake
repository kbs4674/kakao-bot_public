## rake "crawling_fine_dust_gyunggido:crawling_fine_dust_gyunggido"

namespace :crawling_fine_dust_gyunggido do
  require 'rubygems'
  require 'rest_client'
  require 'cgi'
  
  task crawling_fine_dust_gyunggido: :environment do
    ...
    headers = { :params => { CGI::escape('numOfRows') => '30',CGI::escape('pageNo') => '1', CGI::escape('sidoName') => "경기", CGI::escape('ver') => "1.3" } }
