## rake "crawling_fine_dust_jeju:crawling_fine_dust_jeju"

namespace :crawling_fine_dust_jeju do
  require 'rubygems'
  require 'rest_client'
  require 'cgi'
  
  task crawling_fine_dust_jeju: :environment do
    ...
    headers = { :params => { CGI::escape('numOfRows') => '15',CGI::escape('pageNo') => '1', CGI::escape('sidoName') => "제주", CGI::escape('ver') => "1.3" } }
    ...
    for num in 0..@finedust_to_hash.length-1
      ...
      @finedust_result.province = "제주특별자치도 제주시"
